...
@section('content')
    ...
    <div class="row">
        <div class="class-xs-12">
            ...
            <br />
            {{ Form::open(['url' => action('Admin\QRCodeController@updateQRCode', ['id' => $qrcode->id]), 'method' => 'put', 'class' => 'form-horizontal form-label-left']) }}
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Total Point <span class="required">*</span></label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {{ Form::number('point', $qrcode->point, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required']) }}
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Event <span class="required">*</span></label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {{ Form::select('event', $events, $qrcode->event_id) }}
                    </div>
                </div>
