...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Edit Participant ({{ $participant->name }}) <small>Fill up all the fields</small></h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                  @include('errors.errorHandler')
                  <br />
                  {{ Form::model($participant, ['url' => action('Admin\ParticipantController@updateParticipant', ['id' => $participant->id]), 'method' => 'put', 'class' => 'form-horizontal form-label-left']) }}
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          {{ Form::text('mobile_number', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required']) }}
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          {{ Form::text('identity_passport', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required']) }}
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Activate <span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="checkbox">
                              <label>
                                  {{ Form::checkbox('activated', null, null, ['class' => 'js-switch']) }}
                              </label>
                            </div>
                      </div>
                    </div>
                    ...
                    @foreach($fields as $field)
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                              {{ Form::text($field->getFormKey(), $participant->getFieldValue($field->id), ['class' => 'form-control col-md-7 col-xs-12']) }}
                          </div>
                        </div>
                    @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {{ Form::select('event', $events, $participant->event_id) }}
                        </div>
                    </div>
